...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(' parsamollaie66@gmail.com');
    setHasCopied(true);
  ...
  return (
    <section className="c-space my-40" id="about">
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            />
            <div>
              <p className="grid-headtext">Hi, I&apos;m Parsa </p>
